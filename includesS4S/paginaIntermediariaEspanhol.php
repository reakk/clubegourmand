...
<table cellpadding="0" cellspacing="0" border="0" width=991px valign="vtop">
 				...
 				<div class="divDestaque" > <!-- inicio div BATEPAPO -->
					 <div class="divTituloDestaque" style="<?php echo $styleTitulo?>">
						<span class="tituloCaixas" >
						    <div id="divTitulo">
						    <?php require ("montaVoceEstaEm.php");?> <b>Espa&ntilde;ol</b>
                            </div>
						</span>  
					 </div>
...
?>
							...
							<a class='label' href="index.php?option=com_content&view=article&id=47&id_produto=2135&id_menu=7465"  style="text-decoration:none; color:black; font-family: georgia,tahoma,arial; font-size:9pt;"><strong><i>Comentario de  Coyuntura</i></strong></a></span></p>

							<p style="margin-top:10px;">	<span style='cursor: hand'><img src="images/icones/bullet.png" style='margin-left:10px;margin-right:2px'>
							<a class='label' href="index.php?option=com_content&view=article&id=47&id_produto=2138&id_menu=7473"   style="text-decoration:none; color:black; font-family: georgia,tahoma,arial; font-size:9pt;"><strong><i>Coyuntura Pol&iacute;tica</i></strong></span></p></a>
							
							<p style="margin-top:10px;">	<span style='cursor: hand'><img src="images/icones/bullet.png" style='margin-left:10px;margin-right:2px'>
							<a class='label' href="index.php?option=com_content&view=article&id=47&id_produto=2139&id_menu=7474"   style="text-decoration:none; color:black; font-family: georgia,tahoma,arial; font-size:9pt;"><strong><i>Coyuntura Sectorial</i></strong></span></p></a>


							<p style="margin-top:10px;">	<span style='cursor: hand'><img src="images/icones/bullet.png" style='margin-left:10px;margin-right:2px'>
							<a class='label' href="index.php?option=com_content&view=article&id=47&id_produto=2136&id_menu=7466"   style="text-decoration:none; color:black; font-family: georgia,tahoma,arial; font-size:9pt;"><strong><i>Presentaciones</i></strong></span></p></a>
