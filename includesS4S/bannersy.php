        ...
        <ul id="slide_fotos">  
			...
			<li>
                ...
                <?php }else{  ?>
                        ...
                        <a href="<?php echo 'index.php?option=com_content&view=article&id=46&id_conteudo='.$row_banner['id_conteudo_fk'] ?>" target="_self">
                              <img src="imagensBanner/<?php echo $row_banner['imagem_banner']; ?>" alt="" title="<?php echo htmlspecialchars($row[$row_banner]['texto_banner']); ?>" />
                        </a>
