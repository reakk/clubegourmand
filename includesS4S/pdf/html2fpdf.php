...
function Header()
{
$this->Image('http://127.0.0.1/mbnovo/portalB/images/fundo_cabecalho2.jpg',11,5,194,20);
}

function Footer()
{
$this->Image('http://127.0.0.1/mbnovo/portalB/images/fundo_rodape.jpg',11,260,194);
}
