...
$query = " select nome,email,senha from $bancoMBAssociados.usuarios where id_usuarios = " . $_GET["id_cliente"];
$db->setQuery($query);
//echo $query;
...
<tr>
		<td ALIGN='CENTER'>
			...
			<p align="justify">	
				 <b><?php echo $row[0]["nome"];?></b>, seu acesso irá expirar em 7 dias, <br><br>
