...
<tr>
		<td ALIGN='CENTER'>
			...
			<p align="justify">	
				Convidamos o(a) senhor(a) a acessar mais uma ferramenta que a MB Associados disponibiliza ao seus clientes.
			</p>

			<p align="justify" style="margin-top:20px;">
				Nela voc&ecirc; poder&aacute; encontrar todos os coment&aacute;rios, v&iacute;deos e podcasts preparados por nossa equipe, al&eacute;m de toda a base de dados macroecon&ocirc;mica, pol&iacute;tica e setorial incluindo
				as nossas proje&ccedil;&otilde;es para os principais indicadores macroecon&ocirc;micos.
			</p>
