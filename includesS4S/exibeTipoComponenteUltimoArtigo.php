...
<?php
		...
		$resumirDescricao = strlen($descricaoResumido)+strlen($nome);
		echo "<div id='formatacaoDescricaoResumoArtigo'>";
			if($resumirDescricao > 230){
				echo substr(formataDescricaoResumo($rowConteudoArtigo[0]['descricao_resumo'],$nomeColuna,$rowConteudoArtigo[0]['id_conteudo']),0,230-strlen($nome))."...";
