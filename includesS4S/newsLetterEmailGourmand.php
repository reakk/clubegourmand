...
<link rel="stylesheet"
	href="http://www.clubgourmand.com.br/templates/mbAssociados/css/template.css"
	type="text/css" />
</head>
<body>
...
$query = $query . "    on el.id_controle_envio_news_letter = cn.id_controle_envio_news_letter_fk ";
$query = $query . "  WHERE el.id_controle_envio_news_letter = ". $_GET["id"].") order by c.data_criacao desc";
...
$queryTot = $queryTot . "    on el.id_controle_envio_news_letter = cn.id_controle_envio_news_letter_fk ";
$queryTot = $queryTot . " WHERE el.id_controle_envio_news_letter = ". $_GET["id"].") order by c.data_criacao desc";
//echo $queryTot;
...
?>
		...
		<TR>
			...
			?> <?php
				...
				<img
				src='http://www.clubgourmand.com.br/adm/conteudos_upload_mb/<?php echo $arquivo; ?>' />
