...
<form name="form2" id="form2" method="post" action="index.php?option=com_content&view=article&id=49&id_produto=<?php echo $id_produto;?>">
					  ...
					  <div class="divCorpoBancoDeDados"> 
                        ...
                        <div class="divTabelaBancoDados">
							...
							<tr class="headerLista"> 
								...
								<td nowrap><div class="espacamentoColunaData">		Data	<a href="#" onclick=submeterOrderBy('data_criacao','asc')  title="Ordena&ccedil;&atilde;o Crescente"><img src="/mbnovo/portalB/images/iconUp.png" border="0" alt="Ordenação Crescente"></a>  <a href="#" onclick=submeterOrderBy('data_criacao','desc')  title="Ordenação Decrescente"><img src="/mbnovo/portalB/images/iconDown.png" border="0" alt="Ordena&ccedil;&atilde;o Decrescente"></a>		</div>	</td>
								<td nowrap><div class="espacamentoColunaSerie">	S&eacute;rie	<a href="#" onclick=submeterOrderBy('indice_da_serie','asc')  title="Ordena&ccedil;&atilde;o Crescente"><img src="/mbnovo/portalB/images/iconUp.png" border="0" alt="Ordenação Crescente"></a>  <a href="#" onclick=submeterOrderBy('indice_da_serie','desc')  title="Ordenação Decrescente"><img src="/mbnovo/portalB/images/iconDown.png" border="0" alt="Ordena&ccedil;&atilde;o Decrescente"></a></div>	</td>
